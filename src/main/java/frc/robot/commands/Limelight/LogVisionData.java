...
public class LogVisionData extends TimedCommand {
	...
	private String names = "Time,LeftFt,RightFt,SpeedFPS,GyroYaw,BoxHt,BoxWdth,BoxDist,LLAngle,TgtSen\n";
	private String units = "mS,Ft,Ft,FPS,Deg,Px,Px,Ft,Deg,T/F\n";
	...
	protected void execute() {
		if (Robot.createVisionRunFile) {
			...
			Robot.simpleCSVLogger2194.writeData((Timer.getFPGATimestamp() - startTime), Robot.driveTrain.getLeftFeet(),
					...
					Robot.limelightCamera.getdegRotationToTarget(), targetFound);
		}
	}
