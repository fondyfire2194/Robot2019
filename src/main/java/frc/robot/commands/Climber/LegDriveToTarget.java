 ...
 * 
 */
public class LegDriveToTarget extends Command {
	...
	public LegDriveToTarget(double distance, double speed, boolean endItNow, double timeout) {
	...
	protected void initialize() {
		...
		decelerate = false;
		slowDownCounts = Pref.getPref("LegSldnDist");
	}
	...
	protected void execute() {
		...
		remainingCounts = myEndpoint - Robot.climber.getLegEncoderPosition();
		...
		Robot.climber.runClimberLeg(currentMaxSpeed);
	...
	protected boolean isFinished() {
		return isTimedOut() || myEndItNow || Robot.climber.getLegEncoderPosition() >= myEndpoint;
	}
