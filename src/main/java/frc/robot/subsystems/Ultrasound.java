...
private String myName;
  public Ultrasound(int analogPin, ultrasoundType type, double voltsPerUnit, String name) {
...
myName = name;
  ...
  public void updateStatus() {
    SD.putN0(myName + " Usnd V ", getVolts()); 
    SD.putN0(myName + " Usnd MM ", getDistanceMM());
    SD.putN1(myName +" Usnd Meters ", getDistanceMetes());
    SD.putN0(myName +" Usnd Inches ", getDistanceInches());
    SD.putN1(myName +" Usnd Feet ", getDistanceFeet());
  }
}
